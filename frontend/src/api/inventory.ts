...
import type { InventoryCat, InventoryItem } from './types';
...
export const inventoryApi = {
  ...
  async create(data: { name: string; cat?: InventoryCat; qty?: number; unit?: string; minQty?: number }): Promise<InventoryItem> {
